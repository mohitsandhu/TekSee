...
public class RiderActivity extends FragmentActivity implements OnMapReadyCallback {
                                        ...
                                        if (distanceInkilometers < 0.01) {
                                            ...
                                            handler.postDelayed(new Runnable() {
                                                ...
                                                public void run() {
                                                    ...
                                                    callTekSeeButton.setVisibility(View.VISIBLE);
                                                    callTekSeeButton.setText("Call An TekSee");
                                                    requestActive = false;
                                                    driverActive = false;
                                            ...
                                            callTekSeeButton.setVisibility(View.INVISIBLE);
    ...
    public void callTekSee(View view) {

        Log.i("Info", "Call TekSee");
                    ...
                    request.saveInBackground(new SaveCallback() {
                        ...
                        public void done(ParseException e) {
                            ...
                            if (e == null) {
                                ...
                                callTekSeeButton.setText("Cancel TekSee");
                                requestActive = true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callTekSeeButton = (Button) findViewById(R.id.callTekSee);
                                        ...
                                        if (distanceInKilometers < 0.01) {
                                            ...
                                            handler.postDelayed(new Runnable() {
                                                ...
                                                public void run() {
                                                    ...
                                                    infoTextView.setText("");
                                                    callTekseeButton.setVisibility(View.VISIBLE);
                                                    callTekseeButton.setText("Call a TekSee");
                                                    requestActive = false;
                                                    driverActive = false;
                                                }
                                            }, 5000);
